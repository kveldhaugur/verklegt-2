...
def index(request):
    ...
    context['cereal_category'], context['merch_category'] = get_category_pics()
    context['popular'] = [get_random_item(Items.objects.all()).Image for _ in range(3)]
    context['daily_deals'] = [get_random_item(Items.objects.all()).Image for _ in range(3)]
...
def get_category_pics():
    ...
    return cereal_rand_4, merch_rand_4
